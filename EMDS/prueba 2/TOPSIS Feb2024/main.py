...
def calculate_distances_to_ideals(weighted_matrix, ideal_best, ideal_worst):
...
s_best, s_worst = calculate_distances_to_ideals(weighted_matrix, ideal_best, ideal_worst)
...
with pd.ExcelWriter('Experimentos/TOPSIS2.xlsx', engine='xlsxwriter') as writer:
